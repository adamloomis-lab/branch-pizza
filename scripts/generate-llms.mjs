...
## Business facts
- Business: ${restaurant.name}${restaurant.slogan ? ` ("${restaurant.slogan}")` : ''}
- Established: ${restaurant.foundingDate ?? '1977'}
...
## Contact
Call ${restaurant.telephone} or order online at ${orderUrl}
`
