  ...
  return (
    <LegalLayout title="Privacy Policy" updated="May 2026">
      <p>
        ...
        &ldquo;our&rdquo;) handles information collected through our website at branchpizza.com (the
        &ldquo;Site&rdquo;). We&rsquo;re a family-run pizzeria, not a data company, we collect as little
      ...
      <h2>How We Use It</h2>
      <ul>
        <li>To respond to your questions, ordering inquiries, and other messages.</li>
